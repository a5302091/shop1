		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form action="${pageContext.request.contextPath}/user_insert.action"  id="registerForm"  method="post" novalidate="novalidate" onsubmit="return check()">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/check.action" onclick="change()" title="点击更换验证码">
										</span>
