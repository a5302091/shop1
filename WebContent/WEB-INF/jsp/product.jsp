...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span18 last">
			...
			<div class="sn">
				<div><s:property value="model.pid"/></div>
			</div>
			<div class="info">
				<dl>
					<dt>商城价格:</dt>
			...
			<form action="${ pageContext.request.contextPath }/car_addCar.action" id="carForm" method="post">
				...
				<div class="action">
					...
					<div class="buy">
							<input id="addCart" class="addCart" value="加入购物车" type="button" onclick="addCar()"/>
